...
suite('Functional Tests', function() {
    test('?input=10L (valid input)', function(done){
        chai
            .request(server)
            .keepOpen()
    ...
    test('?input=32g (invalid unit)', function(done){
        chai
            .request(server)
            .keepOpen()
    ...
    test('?input=32g (invalid number)', function(done){
        chai
            .request(server)
            .keepOpen()
    ...
    test('?input=3/7.2/4kilomegagram (invalid number and unit)', function(done){
        chai
            .request(server)
            .keepOpen()
    ...
    test('?input=kg (invalid number and unit)', function(done){
        chai
            .request(server)
            .keepOpen()
